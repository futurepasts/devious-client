package net.runelite.client.plugins.kukiCannon;



import net.runelite.client.plugins.kukiCannon.tasks.Logout;
import net.runelite.client.plugins.kukiCannon.tasks.Reload;
import net.runelite.client.plugins.kukiCannon.tasks.ScriptTask;
...
@PluginDescriptor(name = "KukiCannonReloader", enabledByDefault = false)
@Extension
public class kukiCannon extends Script
{
	...
	protected int loop()
	{
		...
		for (net.runelite.client.plugins.kukiCannon.tasks.ScriptTask task : TASKS)
		{
			if (task.validate())
			{
